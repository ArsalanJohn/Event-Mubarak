...
public class CategoryActivityAdapter extends RecyclerView.Adapter<CategoryActivityAdapter.HomeCatViewHolder> {
Context context;
ArrayList<HomeCategory> arrayList;

    public CategoryActivityAdapter(Context context, ArrayList<HomeCategory> arrayList) {
    ...
    public HomeCatViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(context).inflate(R.layout.categorydesign2,null);
