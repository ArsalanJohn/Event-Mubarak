...
public class VendorDealFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_vendor_deal, container, false);
...
//        Node1= activity.sendData();
        ...
        recyclerView = view.findViewById(R.id.Vendordealdetailrecyclerview);
